...
class _BotCommands:
    def __init__(self):
        ...
        self.MirrorCommand = getCommand('MIRROR_CMD', f'mr{CMD_INDEX}')
        self.UnzipMirrorCommand = getCommand('UNZIP_CMD', f'uzmr{CMD_INDEX}')
        self.ZipMirrorCommand = getCommand('ZIP_CMD', f'zipmirror{CMD_INDEX}')
        self.QbMirrorCommand = getCommand('QBMIRROR_CMD', f'qbmr{CMD_INDEX}')
        self.QbUnzipMirrorCommand = getCommand('QBUNZIP_CMD', f'qbuzmr{CMD_INDEX}')
        ...
        self.LeechCommand = getCommand('LEECH_CMD', f'l{CMD_INDEX}')
        self.UnzipLeechCommand = getCommand('UNZIPLEECH_CMD', f'uzl{CMD_INDEX}')
        self.ZipLeechCommand = getCommand('ZIPLEECH_CMD', f'zipleech{CMD_INDEX}')
        self.QbLeechCommand = getCommand('QBLEECH_CMD', f'qbl{CMD_INDEX}')
        self.QbUnzipLeechCommand = getCommand('QBZIPLEECH_CMD', f'qbuzl{CMD_INDEX}')
        ...
        self.CloneCommand = getCommand('CLONE_CMD', f'c{CMD_INDEX}')
        ...
        self.StatusCommand = getCommand('STATUS_CMD', f's{CMD_INDEX}')
